...
// // //   static const String _wsUrl = 'wss://backend-jfg8.onrender.com/api/voice/agent';
...
// // //       print('🔵 [WebSocket] Scheme: ${uri.scheme}, Host: ${uri.host}, Path: ${uri.path}');
...
// // //       print('⚠️ [WebSocket] isConnected: $_isConnected, channel: ${_channel != null}');
// // //       return;
// // //     }
...
// // //       print('🟡 [WebSocket] Sending audio chunk (size: $audioSize bytes, base64 length: ${base64AudioData.length})');
...
// // //           print('🎵 [WebSocket] Audio chunk received: index=$chunkIndex, size=${audioBase64.length} bytes (base64)');
...
// //       final agentId =
// //           StorageService.getString('ai_selected_agent_id') ?? 'default_agent';
// //       print('🟣 [WebSocket] AGENT ID BEING SENT TO SOCKET: $agentId');
// //       print('🟡 [WebSocket] SENDING chatID: $chatId');
// //       final startMessage = jsonEncode({
// //         'type': 'start',
// //         'userId': _currentUserId,
// //         'chatId': chatId ?? 'new',
...
// //       print('✅ [WebSocket] WebSocket CONNECTED successfully!');
// //       print('✅ [WebSocket] Connection state: $_isConnected');
// //       print('✅ [WebSocket] Start message payload: $startMessage');
// //       print('✅ [WebSocket] ============================================');
// //     } catch (e, stackTrace) {
// //       print('🔴 [WebSocket] ============================================');
// //       print('🔴 [WebSocket] CONNECTION FAILED:');
